...
class FragmentDataModule(L.LightningDataModule):
    def __init__(
        ...
        train_case_ids_file: str = "",
        val_case_ids_file: str = "",
        test_case_ids_file: str = "",
        clinical_repeat_factor: int = 1,
        ...
        self.train_case_ids_file = str(train_case_ids_file or "")
        self.val_case_ids_file = str(val_case_ids_file or "")
        self.test_case_ids_file = str(test_case_ids_file or "")
        self.clinical_repeat_factor = max(1, int(clinical_repeat_factor))
    ...
    def _make_real_dataset(self, split: str) -> Dataset:
        ...
        if has_npz:
            case_ids_file = {
                "train": self.train_case_ids_file,
                "val": self.val_case_ids_file,
                "test": self.test_case_ids_file,
            }.get(split, "")
            return ClinicalFragmentSamplesCached(
                ...
                repeat_factor=self.clinical_repeat_factor if split == "train" else 1,
            )
        else:
