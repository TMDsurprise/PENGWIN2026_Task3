...
_METRIC_ORDER = [
    ...
    "lr",
    "val/qsmall_rot_gt60",
    "val/base_qsmall_rot_deg",
    "val/base_qsmall_trans_mm",
    "val/base_qsmall_tre_mm",
    "val/qlarge_rot_deg",
    "val/qlarge_trans_mm",
    "val/qlarge_tre_mm",
]
...
_HEADER = (
    ...
    "{:>12s}  {:>12s}  {:>10s}  {:>12s}  {:>12s}  {:>12s}  {:>12s}  {:>12s}  "
    "{:>12s}  {:>12s}  {:>10s}  {:>8s}"
).format(
    "epoch", "val/loss", "rot_deg", "trans", "tre", "q_rot_deg", "q_trans_mm",
    "q_tre_mm", "q_rot30", "train/loss", "lr", "q_rot60", "base_q_rot",
    "base_q_trans", "base_q_tre", "qlarge_rot", "qlarge_trans", "qlarge_tre",
    "best", "patience"
)
